  ...
  <div id="carouselExampleIndicators" class="carousel slide my-3" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="d-block w-100" src="http://delfi.vn/uploads/quangcao/slide-7-.png" alt="First slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="http://delfi.vn/uploads/quangcao/59Slide-1-.png" alt="Second slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="http://delfi.vn/uploads/quangcao/slide-5-.png" alt="Third slide">
      </div>
    </div>
